 ...
 */
public class OneFragment extends ChildHomeFragment {
    ...
    public void onResume() {
        Log.i("duy.nq", "OneFragment onResume");
        super.onResume();
    }

    @Override
    public void onDestroyView() {
        Log.i("duy.nq", "OneFragment onDestroyView");
        super.onDestroyView();
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.i("duy.nq", "OneFragment onDestroy");
    }
}
